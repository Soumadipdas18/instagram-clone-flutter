...
import 'package:instagram_clone/pages/home/instabody.dart';
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          elevation: 1.0,
          leading: new Icon(Icons.camera_alt_outlined,color: Colors.black,),
          title: SizedBox(
